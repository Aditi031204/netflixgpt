...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="w-12/12 md:w-4/12 md:h-11/12 md:mt-12 h-8/12 absolute px-7 py-8 bg-black my-36 z-30 mx-auto right-0 left-0 text-white opacity-80">
